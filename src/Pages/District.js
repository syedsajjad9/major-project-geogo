    ...
    return (
        <div>
            {/* {console.log(district_id)} */}
            {
                !searchClicked ?
                (
                <Grid style={{height:'50vh', width:'auto', backgroundColor:'rgba(63,158,214,0.3055555555555556)', backgroundRepeat: "no-repeat",
                  backgroundAttachment: "fixed",
                  backgroundSize: "cover",margin:'5px',}}
                container
                direction="column"
                justify="center"
                alignItems="center"
                ...
                <Select
                    ...
                    searchable={true}
                    searchBy="state_name"
                    style={{width:"50vw", marginBottom:'10px', border:'2px solid black',fontWeight:'bold'}}
                />
                <Select
                    ...
                    style={{width:"50vw", border:'2px solid black',fontWeight:'bold'}}
                />
                <br/>
                <span  style={{fontWeight:'bold'}}>Select age</span>
                ...
                style={{fontWeight:'bold'}} onClick={searchButtonClicked}>SEARCH</Button>
                </Grid>
                )
                :
